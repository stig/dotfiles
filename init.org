...
*** Agenda
    ...
    #+BEGIN_SRC emacs-lisp :tangle no
      ...
      (setq org-stuck-projects '("PROJECT-SOMEDAY" ("TODO" "WAITING") nil ""))

      (setq org-agenda-custom-commands
	    '(("u" "Current Tasks" tags-todo "-SOMEDAY/TODO")
	      ("p" "Current Projects" tags "PROJECT-SOMEDAY"
	...
	(let* ((title (read-string "Slug: "))
      ...
      (setq org-capture-templates
	    '(("t" "TODOs")
	      ...
	      ("l" "Log stuff")
	      ("ll" "Learning" entry (file+datetree "Learning.org")
	       "* %^{Title} %^g\n  %?")

	      ("ld" "Log Daily Activity" entry (file+datetree "DailyLog.org")
	       "* %^{Activity} %^g%^{Hours}p\n\n%?" :empty-lines 1)
	      ("ln" "Note" entry (file+datetree "Notes.org")
	       "* %^{Subject} %^{g}\n\n  %?"
	       :empty-lines 1
	       :clock-in t)
	      ("lr" "Infra Report" entry (file+datetree "Notes.org")
	       "* Infra Weekly Report %^g                        :REPORT:

      ,** What did we complete since last report?

      %?

      ,** What do we plan to complete next?
