...
** LilyPond
   ...
   We can play midi files with VLC, but for this we need a wrapper.
   ...
   #+begin_src sh :mkdirp t :tangle  ~/.local/bin/playmidi :tangle-mode (identity #o755) :prologue "" :epilogue ""
     ...
     /Applications/VLC.app/Contents/MacOS/VLC -I dummy "$@" vlc://quit
   #+end_src

** Zsh

   This is how I set up ZSH. It is a little insestuous, as Emacs
   relies on this...
