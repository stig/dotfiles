...
** Projectile
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     (projectile-register-project-type 'lein-test-prefix '("project.clj")
   ...
   #+BEGIN_SRC emacs-lisp :tangle (when sb/personal-setup-p "~/.emacs.d/init.el")
	...
	(quote
	 ((:name "Inbox" :query "tag:inbox" :key "i")
	  ...
	  (:name "My Threads" :query "thread:\"{from:stig}\" and tag:new" :key "t" :sort-order newest-first :search-type tree)
