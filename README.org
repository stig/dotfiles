...
*** Reading mail with NotMuch
    ...
    user.other_email=sbrautaset@laterpay.net;stig.brautaset@icloud.com;stigbrau@start.no;stigbrau@online.no;stig.brautaset@me.com
...
**** Multiple sending profiles
     ...
     #+BEGIN_SRC emacs-lisp
       ...
       (setq notmuch-fcc-dirs
	     '(("stig@brautaset.org" . "Private/sent +sent +archived -unread -inbox")))
...
*** Downloading email over IMAP
    ...
    #+BEGIN_SRC conf :tangle ~/.mbsyncrc
      ...
      # To rotate:
      # > security delete-generic-password -s mbsync-icloud-password
      # > security add-generic-password -a stig@brautaset.org -s mbsync-icloud-password -w APP-SPECIFIC-PASSWORD
