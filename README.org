...
** Tramp
   ...
   This function lets me re-open the currently open file using
   sudo[fn:: Found at http://www.emacswiki.org/emacs/TrampMode#toc31].
   I've bound it to =C-c C-s=. It works for both local and remote
   buffers.
