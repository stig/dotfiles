  ...
  (org-agenda-custom-commands
   '(("d" "Day Agenda & Important tasks"
      ((agenda "" ((org-agenda-span 'day)))
       (tags-todo "-PROJ/TODO" ((org-agenda-max-entries 3)
				;; Ignore all scheduled items as they should show
				;; up in Agenda view above this.
				(org-agenda-todo-ignore-scheduled 'all)
				(org-agenda-todo-ignore-deadlines 'all)
				(org-agenda-todo-ignore-timestamp 'all)))
       ;; Projects aren't actionable; project tasks are. Present tasks
       ;; at the top, as it's easier to get to. (My cursor is left at
       ;; the top of agenda when invoking the command.)
       (tags-todo "PROJ/TODO" ((org-agenda-max-entries 3)
			       ;; Ignore all scheduled items as they should show
			       ;; up in Agenda view above this.
			       (org-agenda-todo-ignore-scheduled 'all)
     ...
     ;; This is handy as it ignores TODOs scheduled far in the future
     ("R" "Review for Tasks Complete" todo "TODO")))
