...
(use-package org
  ...
  (org-capture-templates
   '(("t" "TODOs")
     ...
     ("tc" "Plain TODO & Clock in" entry (file "") (file "templates/todo.org") :clock-in t)
      ...
      ((agenda "")
       (tags-todo "-@work-MAYBE/TODO"
		  ((org-agenda-max-entries 3)
		   ...
		   (org-agenda-todo-ignore-timestamp 'all))))
      ((org-agenda-span 'day)
       (org-agenda-filter '("-@work" "-MAYBE"))))
     ("g" . "Getting Things Done")
     ("gm" "Maybe"
      ((todo "PROJ")
       (tags-todo "-PROJ/TODO"))
      ((org-agenda-filter '("+MAYBE"))))
     ("gt" "Review for Tasks Complete" tags-todo "-MAYBE-RECURRING/TODO")
     ("gw" "Waiting tasks" tags-todo "-MAYBE/WAITING")
     ("ga" "Archivable" ((todo "COMPLETE")
			 (todo "DONE")
                         (tags "CANCELLED")))
     ("gp" "Projects" todo "PROJ")))
