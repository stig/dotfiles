...
* Install Emacs & tools
  ...
  #+begin_src sh
    ...
    # Email
    nix-env -i isync msmtp notmuch

    nix-env -i awscli clojure curl ditaa editorconfig-core-c fluidsynth freepats gnused gnutls graphviz jq pinentry plantuml pwgen python3-3.7.4 silver-searcher direnv
  #+end_src
...
*** Add hack to make "gnu" ~package-archive~ work
