...
echo "Move identified spam to correct folder on server.."
notmuch search --output=files -- tag:spam and tag:gandi and not folder:"gandi/Junk" | mv_without_uid ~/.mail/gandi/Junk
notmuch search --output=files -- tag:spam and tag:gmail and not folder:"gmail/[Gmail]/Spam" | mv_without_uid ~/.mail/gmail/\[Gmail\]/Spam

echo "Move incorrectly-tagged spam to INBOX.."
notmuch search --output=files -- not tag:spam and tag:gandi and folder:"gandi/Junk" | mv_without_uid ~/.mail/gandi/INBOX
notmuch search --output=files -- not tag:spam and tag:gmail and folder:"gmail/[Gmail]/Spam" | mv_without_uid ~/.mail/gmail/INBOX
