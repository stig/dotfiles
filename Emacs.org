...
I also don't want to use ~package.el~, so I inhibit that here to avoid
loading it.
...
I stole this from [[https://github.com/sulami/dotfiles/blob/master/emacs/.emacs.d/init.el][Robin Schroer's config]].
