  ...
  (org-capture-templates
   `(("t" "TODO" entry (file "") ,(format "* TODO %%? :inbox:%s:"
     ...
     ("b" "Things to Brag about!" entry
      (file+olp+datetree "~/org/bragging.org")
      "* %?"
      :time-prompt t)
  ...
  (org-roam-capture-templates
   '(("d" "Default" plain "%?"
     ...
     ("j" "Jira entry" plain (file "templates/jira.org")
      :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
      :unnarrowed t)
     ("m" "Meeting" plain (file "templates/meeting.org")
      :if-new (file+head "%<%Y%m%d%H%M%S>-${slug}.org" "#+title: ${title}\n")
      :unnarrowed t)))
  (org-roam-dailies-directory "daily/")
  (org-roam-dailies-capture-templates
   (let ((template (f-read-text "~/org/templates/org-roam-daily.org")))
     `(("d" "Journal" entry "* %?"
	:if-new (file+head+olp "%<%Y-%m-%d>.org" ,template ("Journal")))
       ("m" "Most Important Thing" entry "* TODO %? :mit:"
	:if-new (file+head+olp "%<%Y-%m-%d>.org" ,template ("Most Important Thing(s)"))))))
