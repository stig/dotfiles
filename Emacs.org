...
(use-package bug-reference
  :config
  (defun sb/bug-reference-mode-settings ()
    (setq bug-reference-bug-regexp "\\(CIRCLE-\\)\\([1-9][0-9]\\{3,4\\}\\)"
          bug-reference-url-format "http://circleci.atlassian.net/browse/CIRCLE-%s"))
  (add-hook 'bug-reference-mode-hook #'sb/bug-reference-mode-settings))
#+end_src
