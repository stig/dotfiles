...
(setq notmuch-fcc-dirs '(("stig@brautaset.org" . "home/Sent +sent")
			 ("sonar_columns_0n@icloud.com" . "icloud/Sent +sent")
			 ("stig@circleci.com" . "work/Sent +sent")))
(setq notmuch-saved-searches
      (quote
       ((:name "Personal Inbox" :query "tag:personal and tag:inbox" :key "h" :search-type tree)
	(:name "Work Inbox" :query "tag:work and tag:inbox" :key "w" :search-type tree)
