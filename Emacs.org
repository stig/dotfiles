...
(use-package org
  ...
  (org-agenda-custom-commands
   `(("d" "Day Agenda & Top Tasks"
      ...
      ((org-agenda-span 'day)
       (org-agenda-tag-filter-preset '(,(format "-%s"
...
#+begin_src emacs-lisp
(defun org-default-notes-file-from-system-name ()
...
(use-package org
  :straight org-plus-contrib
  :custom
  (org-default-notes-file (org-default-notes-file-from-system-name))
  (org-capture-templates
   '(("t" "TODO" entry (file "") "* TODO %?")
     ("l" "TODO with [l]ink to here" entry (file "") "* TODO %?\ncf %a")

     ("T" "Trip" entry (file "") (file "templates/trip.org"))

     ("j" "Journal Entry" entry (function org-journal-open-current-journal-file)
      "* %(format-time-string org-journal-time-format)%?"
      :jump-to-captured t)
     ("J" "Jira ticket" entry (function org-journal-open-current-journal-file)
...
(use-package org-journal
  :bind (("C-c C-x j" . org-journal-open-current-journal-file))
  :custom
  ...
  (org-journal-file-header
   (lambda (time)
	 ...
	 (with-temp-file year-month-path
       ...
       (format (format "#+title: Week #%s
- tags :: [[file:%s][%s]]"
		       (format-time-string "%V" time) ;; iso calendar week
		       year-month-file
		       year-month-title)))))
