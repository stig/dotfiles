...
#+begin_src emacs-lisp
(defun sb/org-journal-new-entry-location ()
  "Creates a new date entry, if necessary, and moves to the current date."
...
(use-package org
  ...
  (org-capture-templates
   '(("t" "TODO" entry (file "") "* TODO %?")
     ...
     ("j" "Journal Entry" entry (function sb/org-journal-new-entry-location)
      "* %(format-time-string org-journal-time-format)%?"
      :jump-to-captured t)
     ("J" "Jira ticket" entry (function sb/org-journal-new-entry-location)
