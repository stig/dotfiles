...
* Bootstrap package management tools
...
** Flycheck clj-kondo
Automatic linting for Clojure code.
#+BEGIN_SRC emacs-lisp
...
** Org Export Backend: GitHub Flavour Markdown
